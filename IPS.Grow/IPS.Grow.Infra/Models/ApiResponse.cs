...
public struct VjsResource(int identifier, ResourceStatusType status)
{
...
public class ApiResponse
{
    ...
    public VjsResource? Resource { get; set; }
    ...
    public static ApiResponse Success(string message = "Success", VjsResource? resource = null)
        => new()
        {
            IsError = false,
            Title = message,
